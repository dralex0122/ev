...
def main():
    ...
    print("\n=== [v3, 이상치 보정] night ~ pop+housing+employ+floor_res+floor_nonres ===")
    ...
    print("\n=== [v3, 이상치 보정] day ~ pop+housing+employ+floor_res+floor_nonres ===")
    ...
    out_fp = os.path.join(BASE, "daynight_model", "seoul_daynight_model_v3_joined.csv")
