...
NAS = "/mnt/cowork/EV/output/g2sfca_sfast_final_exponential"
...
fig.suptitle("서울 최종안(급속+아파트제외+운영시간반영) G2SFCA — 지수함수 × 2021–2024",
...
fig.savefig("/mnt/cowork/EV/output/maps/g2sfca_final_exponential_16maps.png", dpi=150, bbox_inches="tight", facecolor=SURFACE)
print("saved")
